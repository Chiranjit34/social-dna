...
router.post("/addroom", async (req, res) => {
  try {
    ...
    room.locality = newRoom.locality;
    ...
    if (newRoom.imageurl4 && newRoom.imageurl4.length > 0) {
      room.imageurls.push(newRoom.imageurl4);
    }
    if (newRoom.imageurl5 && newRoom.imageurl5.length > 0) {
      room.imageurls.push(newRoom.imageurl5);
    }
